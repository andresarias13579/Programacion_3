...
class Principal{
	public static void main(String[] args) throws Exception{
		...
		Curso curso1 = new Curso("LENGUAJE DE PROGRAMACION 2", "INF282", 'P',1500.00, 4, 5, sdf.parse("20-03-2025"),
			sdf.parse("08-07-2025"), DiaSemana.MARTES,LocalTime.of(8, 0, 0), LocalTime.of(11, 0, 0));
		//Creamos dos talleres de la sede
		Taller taller1 = new Taller("PYTHON PARA INVESTIGACION CUANTITATIVA","TAL725",'V', 500.00, sdf.parse("28-03-2025"),
			LocalTime.of(13, 0, 0),LocalTime.of(16, 0, 0));
		Taller taller2 = new Taller("INTRODUCCION A LATEX","TAL331",'V', 600.00,sdf.parse("30-03-2025"),LocalTime.of(18, 0, 0),
			LocalTime.of(22, 0, 0));
